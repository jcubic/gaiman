...
async function main() {
    try {
        gaiman.echo(await gaiman.get(`/gaiman.txt`));
        await gaiman.echo_extra(`Hi, What is your name?`, 50);
        let $_name = await gaiman.ask(`name? `);
        gaiman.echo(`Hello ${ $_name }, nice to meet you.`);
    } catch (e) {
        gaiman.error(e);
    }
}
